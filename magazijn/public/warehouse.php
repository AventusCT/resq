      ...
      <div class="card panel">
        ...
        <div class="stats">
          <div class="stats__bar">
            ...
            <div class="progress">
              <div id="bar-available" class="progress__fill progress__fill--green"></div>
            </div>
          </div>
          <div class="stats__bar">
            <div class="stats__head"><span>Bezet</span><span id="bar-busy-label">0 items (0%)</span></div>
            <div class="progress">
              <div id="bar-busy" class="progress__fill progress__fill--red"></div>
            </div>
          </div>
          <div class="stats__bar">
            <div class="stats__head"><span>Gereserveerd</span><span id="bar-reserved-label">0 items (0%)</span></div>
            <div class="progress">
              <div id="bar-reserved" class="progress__fill progress__fill--amber"></div>
            </div>
          </div>
        </div>
      </div>
